...
mama_restaurent = Restaurent("Mamar Restaurement")
def customer_menu():
...
def admin_menu():
    ...
    while True:
        ...
        if choice == 1:
            ...
            admin.add_new_item(mama_restaurent, item)
            ...
            admin.add_employee(mama_restaurent, employee)
        elif choice == 3:
            admin.view_employee(mama_restaurent)
        elif choice == 4:
